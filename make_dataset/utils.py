...
def load_name_equivalence(file_name='../datasets/class_name_equivalence.json'):
...
def load_object_states(file_name='../datasets/object_states.json'):
    abs_dir_path = os.path.dirname(os.path.abspath(__file__))
    file_name_all = os.path.join(abs_dir_path, file_name)
    with open(file_name_all, 'r') as f:
        return json.load(f)

def load_object_placing(file_name='../datasets/object_script_placing.json'):
    abs_dir_path = os.path.dirname(os.path.abspath(__file__))
    file_name_all = os.path.join(abs_dir_path, file_name)
    with open(file_name_all, 'r') as f:
        return json.load(f)
...
def load_properties_data(file_name='../datasets/properties_data.json'):
    abs_dir_path = os.path.dirname(os.path.abspath(__file__))
    file_name_all = os.path.join(abs_dir_path, file_name)
    with open(file_name_all, 'r') as f:
        pd_dict = json.load(f)
...
class graph_dict_helper(object):
    ...
    def add_missing_object_from_script(self, script, precond, graph_dict, id_mapping):
        ...
        # print(len(node_ids), len(list(set(node_ids))))
